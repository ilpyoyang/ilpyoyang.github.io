...
처음에는 회의록 요약 하나만 자동화해도 하루 30분을 아낄 수 있다. 여기에 이슈 분류, PRD 초안, 릴리스 노트까지 더하면 PM이 실제로 집중해야 할 일—사용자 인터뷰, 전략 수립, 팀 조율—에 쓸 수 있는 시간이 늘어난다.

코드는 모두 [GitHub 저장소](https://github.com/ilpyoyang)에서 확인할 수 있다.
